...
export const networks = {
  testnet: {
    ...
    contractId: "CCDH3GTUTXXBCMZ6MX2FBDT2AL536XNXC37MITJCUW2RU63ZNWPLQUCI",
  }
} as const
...
export interface Client {
   ...
   */
  pay_insurance_claim: ({sender, insurance_vault_amount}: {sender: string, insurance_vault_amount: u128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  set_fee: ({admin, fee_fraction}: {admin: string, fee_fraction: u32}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
  ...
  /**
   * Construct and simulate a set_expiry transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  set_expiry: ({admin, expiry_ts}: {admin: string, expiry_ts: u64}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAAOaW5pdGlhbGl6ZV9hbGwAAAAAAAEAAAAAAAAABnBhcmFtcwAAAAAH0AAAABNJbml0aWFsaXplQWxsUGFyYW1zAAAAAAA=",
        ...
        "AAAAAAAAAAAAAAANZXN0aW1hdGVfc3dhcAAAAAAAAAMAAAAAAAAABmluX2lkeAAAAAAABAAAAAAAAAAHb3V0X2lkeAAAAAAEAAAAAAAAAAlpbl9hbW91bnQAAAAAAAAKAAAAAQAAA+0AAAACAAAACgAAAAs=",
        ...
        "AAAAAAAAAAAAAAAcZXN0aW1hdGVfc3dhcF9zdHJpY3RfcmVjZWl2ZQAAAAMAAAAAAAAABmluX2lkeAAAAAAABAAAAAAAAAAHb3V0X2lkeAAAAAAEAAAAAAAAAApvdXRfYW1vdW50AAAAAAAKAAAAAQAAA+0AAAACAAAACgAAAAs=",
        ...
        "AAAAAAAAAAAAAAAKc2V0X2V4cGlyeQAAAAAAAgAAAAAAAAAFYWRtaW4AAAAAAAATAAAAAAAAAAlleHBpcnlfdHMAAAAAAAAGAAAAAA==",
        ...
        "",
        "",
  ...
  public readonly fromJSON = {
    initialize_all: this.txFromJSON<null>,
        ...
        set_expiry: this.txFromJSON<null>,
