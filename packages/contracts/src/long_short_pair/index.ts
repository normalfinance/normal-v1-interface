...
export type DataKey =
  | { tag: 'TokenCollateral'; values: void }
  ...
  | { tag: 'MaxRatioPercentDivergence'; values: void }
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([
        ...
        '',
