...
export interface Client {
  ...
  register_oracle: (
    ...
    }: { admin: string; asset: string; oracle_addr: string; decimals: u32; sanitize_clamp_denominator: u64 },
    options?: {
      /**
       * The fee to pay for the transaction. Default: BASE_FEE
       */
   ...
   */
  update_oracle: (
    { admin, asset, params }: { admin: string; asset: string; params: MutableOracleInfo },
    options?: {
      /**
       * The fee to pay for the transaction. Default: BASE_FEE
       */
   ...
   */
  set_oracle_price: (
    { admin, asset, price }: { admin: string; asset: string; price: u128 },
    options?: {
      /**
       * The fee to pay for the transaction. Default: BASE_FEE
       */
  ...
  set_oracle_guard_rails: (
    { admin, oracle_guard_rails }: { admin: string; oracle_guard_rails: OracleGuardRails },
    options?: {
      /**
       * The fee to pay for the transaction. Default: BASE_FEE
       */
...
export class Client extends ContractClient {
  ...
  public readonly fromJSON = {
    ...
    get_price: this.txFromJSON<readonly [HistoricalOracleData, OracleValidity]>,
    ...
    delete_oracle: this.txFromJSON<null>,
