...
export interface Client {
  ...
  deploy_index_contract: (
    { serialized_asset, params }: { serialized_asset: Buffer; params: IndexParams },
    options?: {
      /**
  ...
  set_index_contract_wasm: (
    { admin, index_contract_wasm }: { admin: string; index_contract_wasm: Buffer },
    options?: {
      /**
       * The fee to pay for the transaction. Default: BASE_FEE
       */
   ...
   */
  convert_token_to_usd: (
    { token, amount }: { token: string; amount: u128 },
    options?: {
      /**
       * The fee to pay for the transaction. Default: BASE_FEE
       */
...
export class Client extends ContractClient {
  static async deploy<T = Client>(
    /** Constructor/Initialization Args for the contract's `__constructor` method */
    {
      ...
      swap_utility,
      index_contract_wasm,
    }: { admin: string; emergency_admin: string; swap_utility: string; index_contract_wasm: Buffer },
    ...
    return ContractClient.deploy({ admin, emergency_admin, swap_utility, index_contract_wasm }, options)
  }
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([
        'AAAAAQAAAAAAAAAAAAAADUZhY3RvcnlDb25maWcAAAAAAAACAAAAAAAAABNpbmRleF9jb250cmFjdF93YXNtAAAAA+4AAAAgAAAAAAAAAAxzd2FwX3V0aWxpdHkAAAAT',
        'AAAAAAAAAAAAAAANX19jb25zdHJ1Y3RvcgAAAAAAAAQAAAAAAAAABWFkbWluAAAAAAAAEwAAAAAAAAAPZW1lcmdlbmN5X2FkbWluAAAAABMAAAAAAAAADHN3YXBfdXRpbGl0eQAAABMAAAAAAAAAE2luZGV4X2NvbnRyYWN0X3dhc20AAAAD7gAAACAAAAAA',
