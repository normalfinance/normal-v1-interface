...
import { fileData, fileThumb, fileFormat } from '@normalfinance/utils/src/format/file-thumbnail';
import { RemoveButton, DownloadButton } from './action-buttons';

import type { FileThumbnailProps } from '@normalfinance/types/src/general/file-thumbnail';
