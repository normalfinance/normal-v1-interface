import type { NativeToken } from '@normalfinance/types/src/general/native-token';
import type { IndexCoin, IIndexItem } from '@normalfinance/types/src/general/indexes';
...
import { useRouter } from '@normalfinance/ui/src/routes/hooks';

import { fData } from '@normalfinance/utils/src/format/format-number-locale';

// import { toast } from 'src/components/snackbar';
import { Form, Field, schemaHelper } from '@normalfinance/ui/src/components/hook-form';
...
export function NewIndexForm({ currentIndex, tokenSymbol, availableCoins }: Props) {
  ...
  const coinList = useWatch<NewIndexSchemaType, 'indexCoinList'>({
    control,
    name: 'indexCoinList',
  }) as IndexCoin[];
