...
import type { RealtimeChartData } from '@normalfinance/utils/src';
...
import { fNumber, fShortenNumber } from '@normalfinance/utils/src';

import { Chart, useChart, ChartSelect, ChartLegends } from 'src/components/chart';

import type { LegendValue } from '../area-chart-card';
