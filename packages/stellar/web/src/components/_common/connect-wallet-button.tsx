...
import { Box, Grid, Modal, Button, Skeleton, Typography } from '@mui/material';
...
export function ConnectWalletButton({ open, setOpen, connectors, connect }: ConnectWalletProps) {
  ...
  return (
    ...
    >
      <Grid container spacing={0} sx={{ marginTop: '1.5rem', height: '100%', ...modalStyle }}>
        <Grid
          item
          xs={12}
          md={6}
        ...
        >
          ...
          {!loadingConnectors ? (
            <>
              <Typography sx={{ fontSize: 14, opacity: 0.4, marginBottom: '1.5rem' }}>
            ...
            >
              <Skeleton variant="rectangular" width="100%" height={60} sx={skeletonStyles} />
              <Skeleton variant="rectangular" width="100%" height={60} sx={skeletonStyles} />
              <Skeleton variant="rectangular" width="100%" height={60} sx={skeletonStyles} />
            </Box>
          )}
        </Grid>
        <Grid item xs={12} md={6} sx={{ padding: '1.5rem 1rem', flexBasis: '100%!important' }}>
          {loading ? (
            // <motion.div
            //   initial={{ scale: 0.9 }}
            //   animate={{ scale: 1 }}
            ...
            >
              <img
                src={selected?.id === 'freighter' ? '/image-105.png' : selected?.iconUrl || ''}
                alt="Loading Wallet"
                style={{ width: '180px' }}
              />
              ...
              <Button sx={{ width: '100%' }} onClick={handleBack} color="secondary">
                Back
              </Button>
            </Box>
          ) : (
            ...
            >
              ...
              >
                <img src="/x.svg" alt="Close" style={{ width: '1.5rem', height: '1.5rem' }} />
              </Box>
            </Box>
          )}
        </Grid>
