import type { EnumStr } from '@/types/constants'
import type { ParsedUrlQuery } from 'querystring'
import type { ApiPoolInfoItem } from '@raydium-io/raydium-sdk'
...
import { omit, objectShakeFalsy } from '@/functions/objectMethods'
...
import { QuantumSOLVersionSOL, QuantumSOLVersionWSOL } from '../token/quantumSOL'
...
export default function useSwapUrlParser(): void {
  ...
  useAsyncEffect(async () => {
    ...
    if (coin1Amount) useSwap.setState({ coin1Amount })
    if (coin2Amount) useSwap.setState({ coin2Amount })
