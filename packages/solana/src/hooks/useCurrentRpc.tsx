...
import { type RpcEndpoint, EnvironmentConstants } from '@/constants/EnvironmentConstants';
...
const _useCurrentRpc = () => {
  ...
  const rpcToUse = Env.driftEnv === 'mainnet-beta' ? DEFAULT_MAINNET_RPC : DEVNET_RPCS[0];
