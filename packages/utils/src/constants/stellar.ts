...
const TESTNET_CONFIG: NetworkConfig = {
  ...
  // External Contracts
  AQUA_ROUTER_ADDRESS:
    process.env.NEXT_PUBLIC_TESTNET_AQUA_ROUTER_CONTRACT ||
...
const MAINNET_CONFIG: NetworkConfig = {
  ...
  // External Contracts
  AQUA_ROUTER_ADDRESS:
    process.env.NEXT_PUBLIC_MAINNET_AQUA_ROUTER_CONTRACT ||
    'CBQDHNBFBZYE4MKPWBSJOPIYLW4SFSXAXUTSXJN76GNKYVYPCKWC6QUK',
  AQUA_API_BASE_URL:
    process.env.NEXT_PUBLIC_MAINNET_AQUA_API_BASE_URL ||
