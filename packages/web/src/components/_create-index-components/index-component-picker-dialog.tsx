...
import type { Token, IndexFundComponent } from '@normalfinance/types';
...
type Props = {
  open: boolean;
  onClose: () => void;
  onSelectTokens: (selectedTokens: IndexFundComponent[]) => void;
  tokens: Token[];
};

export default function IndexComponentPickerDialog({
  open,
  onClose,
  onSelectTokens,
  tokens,
